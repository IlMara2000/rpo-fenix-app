  ...
  const handleScannerSubmit = async (e) => {
    ...
    try {
      ...
      if (result && result.success) {
        ...
        setStatus({ msg: `SCANSIONE COMPLETATA`, type: 'yellow' });
      }
      ...
      <div className="max-w-xl w-full">
        ...
        <div className="space-y-12">
          ...
          <section className="box-lavoro relative overflow-hidden group">
            ...
            <p className="text-gray-400 text-xs leading-relaxed mb-8 pr-10">
              Carica il file TXT di risposta RPO e separa automaticamente i numeri in due liste.
            </p>
              ...
              {scannerFiles && (
                ...
                <div className="pt-6 border-t border-white/10 mt-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <button
                      type="button"
                      onClick={() => saveAs(scannerFiles.txtZero, `numeri_rpo_0_${scannerFiles.fileName}.txt`)}
                      className="bottone-download"
