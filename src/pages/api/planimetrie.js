  ...
  form.parse(req, async (err, fields, files) => {
    ...
    try {
      ...
      try {
        ...
        throw new Error("File ngrok_config.json non trovato. Hai premuto il Bottone 3 sul Mac?");
      }

      const apiUrl = `${ngrokUrl}/sdapi/v1/img2img`;
      console.log(`🚀 Inviando planimetria al Mac Mini M4: ${apiUrl}`);

      // 3. CHIAMATA DIRETTA AL TUO MAC MINI M4
